...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Invoi__copyl__6A30C649] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[str_Invoice] ADD CONSTRAINT [PK__str_Invo__9A159A360A3E4199] PRIMARY KEY CLUSTERED  ([str_invoiceid])
GO
