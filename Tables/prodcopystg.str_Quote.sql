...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Quote__copyl__628FA481] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[str_Quote] ADD CONSTRAINT [PK__str_Quot__965E13A672C6BDBF] PRIMARY KEY CLUSTERED  ([str_quoteid])
GO
