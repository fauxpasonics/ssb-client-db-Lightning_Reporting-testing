...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__SystemUse__copyl__38996AB5] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[SystemUser] ADD CONSTRAINT [PK__SystemUs__E4276C1F1A1ED4E0] PRIMARY KEY CLUSTERED  ([systemuserid])
GO
