...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Sales__copyl__6FE99F9F] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[str_SalesOrder] ADD CONSTRAINT [PK__str_Sale__F4B3FD81F06C3CBF] PRIMARY KEY CLUSTERED  ([str_salesorderid])
GO
