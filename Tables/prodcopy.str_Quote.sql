...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Quote__copyl__5CD6CB2B] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[str_Quote] ADD CONSTRAINT [PK__str_Quot__965E13A6A1502C1E] PRIMARY KEY CLUSTERED  ([str_quoteid])
GO
