...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Oppor__copyl__5FB337D6] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[str_Opportunity] ADD CONSTRAINT [PK__str_Oppo__0ACAF85A3DC62A9B] PRIMARY KEY CLUSTERED  ([str_opportunityid])
GO
