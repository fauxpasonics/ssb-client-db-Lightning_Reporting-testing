...
[new_ssbcmrystemdimcustomerids] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [prodcopystg].[Account] ADD CONSTRAINT [PK__Account__F20699F66D8FCD4E] PRIMARY KEY CLUSTERED  ([accountid])
GO
