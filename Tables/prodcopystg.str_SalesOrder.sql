...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Sales__copyl__72C60C4A] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[str_SalesOrder] ADD CONSTRAINT [PK__str_Sale__F4B3FD8191031359] PRIMARY KEY CLUSTERED  ([str_salesorderid])
GO
